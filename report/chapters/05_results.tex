...
\input{figures/models/benchmark_table}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.82\textwidth]{figures/models/cost_curve_all_models}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.72\textwidth]{figures/models/cost_sensitivity}
